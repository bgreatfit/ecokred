...
<li class="<?php if($page == 'sellers'){ echo "active";}?>">
    <a href="javascript:;" data-toggle="collapse" data-target="#sellers">Sellers<i class="fa fa-fw fa-caret-down"></i><span class="sb-menu-icon fa fa-list-ul"></span></a>
    <ul id="sellers" class="collapse">
        <li class="<?php if($page == 'seller'){ echo "active";}?>">
            <a href="sellers">View all Sellers</a>
        </li>
        <li class="<?php if($page == 'add-seller'){ echo "active";}?>">
            <a href="add-seller">Add Sellers</a>
        </li>
    </ul>
</li>
<li class="<?php if($page == 'products'){ echo "active";}?>">
    <a href="javascript:;" data-toggle="collapse" data-target="#products"> Products<i class="fa fa-fw fa-caret-down"></i><span class="sb-menu-icon fa fa-list-ul"></span></a>
    <ul id="products" class="collapse">
        <li class="<?php if($page == 'products'){ echo "active";}?>">
            <a href="products">View all Products</a>
        </li>
        <li class="<?php if($page == 'add-product'){ echo "active";}?>">
            <a href="add-product">Add Products</a>
        </li>
    </ul>
</li>
<li class="<?php if($page == 'services'){ echo "active";}?>">
    <a href="javascript:;" data-toggle="collapse" data-target="#services"> Services<i class="fa fa-fw fa-caret-down"></i>
    ...
    <ul id="services" class="collapse">
        ...
        <li class="<?php if($page == 'add-product'){ echo "active";}?>">
            <a href="add-service">Add Services</a>
        </li>
    </ul>
</li>
<li class="<?php if($page == 'sliders'){ echo "active";}?>">
    <a href="sliders"> Sliders
        <span class="sb-menu-icon fa fa-list-ul"></span></a>
