...
<th class="hidden-xs va-m sorting" tabindex="0" aria-controls="datatable2" rowspan="1" colspan="1" aria-label="State: activate to sort column ascending" style="width: 39px;">Points</th>
...
&nbsp;&nbsp;
<a href="javascript:;" class="del text-primary" id="<?php echo $row->id;?>" title="Delete"><i class="fa fa-trash"></i></a>
&nbsp;&nbsp;
<?php
if($row->approve == 1){
?>
<a href="javascript:;" class="disapprove text-warning" id="<?php echo $row->id;?>" title="Disapprove"><i class="fa fa-thumbs-down"></i></a>
<?php }else{?>
<a href="javascript:;" class="approve text-info" id="<?php echo $row->id;?>" title="Approve"><i class="fa fa-thumbs-up"></i></a>
<?php }?>
</span>
</td>
