    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-nav navbar-left pull-right hidden-md hidden-lg">
                ...
                <li style="float:right;"><a class="navbar-right pull-right" href="login.php" class="loginModal" data-onok="#" >Sign In</a></li>
            </ul>
        </div><!--.navbar-header-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left hide-on-focus">
                ...
                <li class="hidden-xs hidden-md hidden-lg"><a href="login.php" class="loginModal active" data-onok="/emp/u/shop-by-store.vm?">Sign In</a></li>
                <li class="hidden-sm hidden-md hidden-lg active"><a href="login.php">Sign In</a></li>
            ...
            <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
                <li><a href="login.php" class="loginModal active" data-onok="login.php">Sign In</a></li>
...
<div class="container">
    ...
    <div id="signin-form" class="col-md-6 login-form-validation">
        ...
        <div class="alert alert-danger hide hidden-sm hidden-md hidden-lg" role="alert">
            <span class="pull-left alert-icon danger"></span>

            <p class="alert-description" id="email-error-p"></p>

            <p class="alert-description" id="password-error-p"></p>

            <p class="alert-description" id="recaptcha-error"></p>
        </div>
        ...
        <form id="signinForm" name="registration" action="https://www.mypoints.com/emp/u/login.do?"
            ...
            <input id="fpBlackBox" type="hidden" name="fpBlackBox"
                   value=""/>
            <input id="ioBlackBox" type="hidden" name="ioBlackBox"
                   value=""/>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary submit-base-login">Sign In</button>
            </div>
            <div class="form-group">
                <p><a href="/emp/u/forget.do">Forgot your password?</a></p>
            </div>
