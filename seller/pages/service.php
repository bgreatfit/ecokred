                                            ...
                                            <form id=" Form" class="form" action="" method="POST" enctype="multipart/form-data">
                                                <div class="form-group earn-info">
                                                    ...
                                                    if(isset($_POST['submit'])){
                                                        //var_dump($_FILES);
                                                        if($_FILES['pics']['name'] AND $_POST['sname'] AND $_POST['price'] AND $_POST['details'] AND $_POST['points']){
                                                            ...
                                                            if($size > 2000){?>
                                                                ...
                                                                if(move_uploaded_file($_FILES['pics']['tmp_name'], $target_file)){
                                                                    ...
                                                                    $serviceId = rand_string();
                                                                    $q12 = $conn->prepare("INSERT INTO services(name,manufacturer_id,service_code,thumbnail,details,price,points,timestamp,service_type,service_cat_id) VALUES(:name,:man,:scode,:tmb,:det,:price,:pts,:time,'seller',:service_cat_id)");
                                                                    ...
                                                                    $q12->bindValue(':scode', $serviceId);
                                                                    $q12->bindValue(':service_cat_id', $service_cat_id);
                                                                    if($q12->execute()){
                                                                        exit(header('location:service?sid='.$serviceId.'&success=true'));
                                                                    }
                                                                }
                                                            }
                                                        }else{
                                                    ...
                                                    <?php if(isset($_GET['success']) AND ($_GET['success'] == "true")){?>
                                                        <div class='alert alert-success'>
                                                            <i class='fa fa-check'></i> Service with earning code [<?php echo $_GET['sid'];?>] created! <button class='close' data-dismiss='alert'>&times;</button>
                                                        </div>
                                                    <?php }?>
                                                </div>
