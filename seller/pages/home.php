...
<div class="col-md-7 mb10 col-sm-6 col-xs-12">
	...
	<form id="productForm" class="form" action="" method="POST" enctype="multipart/form-data">
        <div class="form-group earn-info">
			...
			<?php
					...
					if(move_uploaded_file($_FILES['pics']['tmp_name'], $target_file)){
						...
						$q12 = $conn->prepare("INSERT INTO products(name,manufacturer_id,product_code,thumbnail,details,price,points,timestamp,product_cat_id) VALUES(:name,:man,:pcode,:tmb,:det,:price,:pts,:time,:product_cat_id)");
						...
						if($q12->execute()){
							exit(header('location:home?pid='.$productId.'&success=true'));
						}
					}
				}
			}else{
		...
		<div class="form-group">
            ...
            <input type="number" min="0" value="<?php if(isset($_POST['points'])){ echo $_POST['points'];}?>" placeholder="Assign points" name="points" class="form-control">
        </div>
		<div class="form-group">
